...
$(document).ready(function () {
    ...
    $("#popupWindow").on('open', function () {
        $("#txtTestimonialCatName").jqxInput('selectAll');
    });
});
    ...
    var source =
        {
            ...
            datafields: [
                { name: 'Id', type: 'int' },
                { name: 'TestimonialCategoryName', type: 'string' },
    ...
    $("#jqxgrid").jqxGrid(
        {
            ...
            columns: [
                ...
                { text: 'Name', datafield: 'TestimonialCategoryName', width: "200px" },
    ...
    $("#btnSave").click(function () {
        if (validateRequiredFields()) {
            if (editrow >= 0) {
                ...
                var dataSave = {
                    "Id": dataRecord.Id,
                    "TestimonialCategoryName": $("#txtTestimonialCatName").val(),
...
function onhypEditClick(row) {
    ...
    $("#txtTestimonialCatName").val(dataRecord.TestimonialCategoryName);
    $("#popupWindow").jqxWindow('open');
...
function onhypDeleteClick(row) {
    ...
    if (confirm("Are you sure what to delete '" + dataRecord.TestimonialCategoryName + "' Category?")) {
        var request = $.ajax({
...
function onhypDisplayOrderClick(id, upDown) {
    loadAll(RefreshData, "/CoreModule_General/ChangeTestimonialCategoryDisplayOrder?id=" + id + "&upDown=" + upDown);
}
