...
function addPage(parentId) {
    ...
    $('#PageLayoutPath').val("");
    $("#chkShowInNavigation").prop('checked', false);
}
...
function editPage(pageid) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#lblPageId').html(response.Page.PageID);
            $('#lblItemPath').html(response.Page.FullItemPath);
            ...
            $("#chkShowInNavigation").prop('checked', response.Page.ShowInNavigation);
        },
...
function savePage() {
    ...
    page.ShowInNavigation = $('#chkShowInNavigation').is(':checked');
    console.log(page)
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            //alert('Saved');
            $.toaster({ priority: 'success', title: 'Save', message: 'Detail saved successfully' });
            //bootbox.alert("Page datails saved!", function () {
            //});
        },
        failure: function (response) {
            console.log('error', response);
            $.toaster({ priority: 'error', title: 'Not Save', message: 'Oops, Error occured while saving data. Please try again' });
