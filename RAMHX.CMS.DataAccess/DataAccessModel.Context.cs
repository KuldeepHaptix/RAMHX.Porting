...
namespace RAMHX.CMS.DataAccess
{
    ...
    public partial class DatabaseEntities : DbContext
    {
        ...
        public virtual DbSet<app_Configs> app_Configs { get; set; }
        public virtual DbSet<AspNetRole> AspNetRoles { get; set; }
        public virtual DbSet<AspNetUserClaim> AspNetUserClaims { get; set; }
        public virtual DbSet<AspNetUserLogin> AspNetUserLogins { get; set; }
        public virtual DbSet<AspNetUser> AspNetUsers { get; set; }
        public virtual DbSet<cms_PageFieldValues> cms_PageFieldValues { get; set; }
        public virtual DbSet<cms_PageHTMLModules> cms_PageHTMLModules { get; set; }
        public virtual DbSet<cms_PageRoles> cms_PageRoles { get; set; }
        public virtual DbSet<cms_Pages> cms_Pages { get; set; }
        public virtual DbSet<cms_TemplateFields> cms_TemplateFields { get; set; }
        public virtual DbSet<cms_Templates> cms_Templates { get; set; }
        public virtual DbSet<cms_UpgradeHistory> cms_UpgradeHistory { get; set; }
        public virtual DbSet<HtmlModule> HtmlModules { get; set; }
        public virtual DbSet<cms_301Redirection> cms_301Redirection { get; set; }
        public virtual DbSet<cms_PackageInstallations> cms_PackageInstallations { get; set; }
        public virtual DbSet<CoreModule_FAQCategory> CoreModule_FAQCategories { get; set; }
        public virtual DbSet<CoreModule_FAQMaster> CoreModule_FAQMasters { get; set; }
        public virtual DbSet<CoreModule_GalleryAlbum> CoreModule_GalleryAlbums { get; set; }
        public virtual DbSet<CoreModule_GalleryAlbumItem> CoreModule_GalleryAlbumItems { get; set; }
        public virtual DbSet<CoreModule_GalleryCategory> CoreModule_GalleryCategories { get; set; }
        public virtual DbSet<CoreModule_JobCategory> CoreModule_JobCategories { get; set; }
        public virtual DbSet<CoreModule_JobMaster> CoreModule_JobMasters { get; set; }
        public virtual DbSet<CoreModule_PackageCategory> CoreModule_PackageCategories { get; set; }
        public virtual DbSet<CoreModule_PackageMaster> CoreModule_PackageMasters { get; set; }
        public virtual DbSet<CoreModule_ProductCategory> CoreModule_ProductCategories { get; set; }
        public virtual DbSet<CoreModule_ProductMaster> CoreModule_ProductMasters { get; set; }
        public virtual DbSet<CoreModule_ProjectCategory> CoreModule_ProjectCategories { get; set; }
        public virtual DbSet<CoreModule_ProjectMaster> CoreModule_ProjectMasters { get; set; }
        public virtual DbSet<CoreModule_TestimonialCategory> CoreModule_TestimonialCategories { get; set; }
        public virtual DbSet<CoreModule_TestimonialMaster> CoreModule_TestimonialMasters { get; set; }
        public virtual DbSet<CoreModule_BlogCategory> CoreModule_BlogCategories { get; set; }
        public virtual DbSet<CoreModule_Blog> CoreModule_Blogs { get; set; }
        public virtual DbSet<CoreModule_EventCategory> CoreModule_EventCategories { get; set; }
        public virtual DbSet<CoreModule_Event> CoreModule_Events { get; set; }
        public virtual DbSet<CoreModule_New> CoreModule_News { get; set; }
        public virtual DbSet<CoreModule_NewsCategory> CoreModule_NewsCategories { get; set; }
        public virtual DbSet<CoreModule_SliderItem> CoreModule_SliderItems { get; set; }
        public virtual DbSet<CoreModule_Slider> CoreModule_Sliders { get; set; }
        public virtual DbSet<CoreModule_SMSQueue> CoreModule_SMSQueues { get; set; }
        public virtual DbSet<AppForgotPasswordToken> AppForgotPasswordTokens { get; set; }
        ...
        public virtual int AddAspNetUserRoles(string userid, string roleid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddAspNetUserRoles", useridParameter, roleidParameter);
        }
    
        public virtual int DeleteAspNetUserRoles(string userid)
        {
            var useridParameter = userid != null ?
                new ObjectParameter("userid", userid) :
                new ObjectParameter("userid", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteAspNetUserRoles", useridParameter);
        }
    
        public virtual int GetAspNetUserRoles(string userid)
        {
            var useridParameter = userid != null ?
                new ObjectParameter("userid", userid) :
                new ObjectParameter("userid", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetAspNetUserRoles", useridParameter);
        }
    
        public virtual ObjectResult<GetAspNetUsersByRole_Result> GetAspNetUsersByRole(string roleId)
        {
            var roleIdParameter = roleId != null ?
                new ObjectParameter("roleId", roleId) :
                new ObjectParameter("roleId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAspNetUsersByRole_Result>("GetAspNetUsersByRole", roleIdParameter);
        }
    }
}
